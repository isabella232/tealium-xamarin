...
msbuild $proj_firebase_common /t:Clean /p:Configuration=$Configuration
msbuild $proj_firebase_ios /t:Clean /p:Configuration=$Configuration
msbuild $proj_firebase_droid /t:Clean /p:Configuration=$Configuration
...
msbuild $proj_firebase_common /p:Configuration=$Configuration
msbuild $proj_firebase_ios /p:Configuration=$Configuration
msbuild $proj_firebase_droid /p:Configuration=$Configuration
...
cp Integrations/Firebase/$firebase_common/bin/$Configuration/$firebase_common.dll ./Distribution
cp Integrations/Firebase/$firebase_droid/bin/$Configuration/$firebase_droid.dll ./Distribution
cp Integrations/Firebase/$firebase_ios/bin/$Configuration/$firebase_ios.dll ./Distribution
